...
const AdminLogoNav = ({ onMenuToggle, isMobile }) => {
  ...
  return (
    <div className="px-3 sm:px-4 md:px-6 lg:px-8 py-2 md:py-1.5 bg-light-grey col-span-5 row-span-1 border-b border-dark-grey/50 flex items-center justify-between">
