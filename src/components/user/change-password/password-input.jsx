    ...
    <>
      <div className="relative">
        <input
          ...
          className={`w-full rounded-xl bg-[#CECECE] px-2 sm:px-3 md:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm md:text-base text-white placeholder-white outline-none transition-all duration-200 focus:ring-2 min-h-9 sm:min-h-10 md:min-h-11 ${
        ...
        <button
          ...
          className="absolute right-2 sm:right-3 md:right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors"
